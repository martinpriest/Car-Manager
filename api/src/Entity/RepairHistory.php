 ...
 * RepairHistory
 *
 * @ORM\Table(name="repair_history", indexes={@ORM\Index(name="idCar", columns={"idCar"}), @ORM\Index(name="idFacture", columns={"idFacture"}), @ORM\Index(name="idUser", columns={"idUser"})})
 * @ORM\Entity
 */
class RepairHistory
{
