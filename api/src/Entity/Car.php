 ...
 * Car
 *
 * @ORM\Table(name="car", indexes={@ORM\Index(name="idCarGroup", columns={"idCarGroup"}), @ORM\Index(name="idAvatarFile", columns={"idAvatarFile"}), @ORM\Index(name="idUser", columns={"idUser"})})
 * @ORM\Entity
 */
class Car
{
